...
BASE_IMAGE = pygame.transform.scale2x(pygame.image.load(os.path.join("img", "base.png")))
BG_IMAGE = pygame.transform.scale2x(pygame.image.load(os.path.join("img", "bg.png")))
